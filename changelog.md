...
- 가혹 검수: 23개 업무·시간·도우미·통계/22개 저장·정정 브라우저 묶음 및2684교차조합/도우미11묶음. 구형 검사 대신 현재 UI의 격리 검사를 기본 진입점으로 연결. APK v37/versionCode10, 기존 서명 유지. 공개 상태는 VERIFICATION_v37.md 기준.
