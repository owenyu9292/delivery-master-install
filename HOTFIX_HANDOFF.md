...
# 통계 확장 로컬 검수 완료 / 미배포 (2026-09-09)

- 최신 수정은 통계 확장이다. `VERIFICATION_statistics_2026-09-09.md` 참조. 커밋·푸시·신규 APK 배포는 아직 하지 않았다. 실제 공개본은 아래 v37이다.
- 사용자 v37 설치 확인. 이번 통계판의 실기기 검수는 별도이며, 통계는 원본을 저장하거나 변경하지 않는다.
...
- 핫픽스 작업 시 이 미커밋 소스 변경을 버리거나 배포 완료로 오해하지 않는다. PWA는 계속 보관용이다.
