...
- 상태: APK 빌드·검수·GitHub 게시·비로그인 다운로드 해시 확인 완료. 소스/APK 커밋541eaf0, 태그v35.
...
- GitHub Release 게시 URL: https://github.com/owenyu9292/delivery-master-install/releases/tag/v35 (Release ID383249117).
- 공개 다운로드 검증: 25,388,917바이트, SHA-256 529C6D2323103BB908C7202EF330A59947284C07B1A71A860D0F43D9FEED07D2. 로컬 APK와 GitHub asset digest 및 실제 다운로드 해시가 모두 일치한다.
